...
description: "Starting with AI has nothing to do with which model you pick. Here's the first thing a beginner should actually build."
cover:
  image: "cover-beginner.png"
  alt: "Building with AI — where to actually start"
---
